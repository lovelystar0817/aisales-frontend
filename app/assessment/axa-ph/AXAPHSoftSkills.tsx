...
export default function AXAPHSoftSkills() {
  const { t } = useTranslation();
  const { axaPhSoftSkillsData: data } = useAssessmentContext();
  ...
  return (
    <section id="axa-ph-soft-skills" className="rounded-2xl bg-[#FFFFFF] p-4">

...
export default function KTAXAKnowledgeSkills() {
  const { t } = useTranslation();
  const { ktAxaKnowledgeSkillsData: data, session } = useAssessmentContext();
        ...
        <div className="relative flex items-center justify-between bg-white py-2">
          <div className="flex-1 pr-6">
            ...
            <p className="text-[14px] text-[#58595A]">
              {t(`assessment.${localeKey}.sectionDescriptions.knowledgeSkills`)}
            </p>
          </div>

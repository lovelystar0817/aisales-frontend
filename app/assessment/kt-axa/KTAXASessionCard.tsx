...
const KTAXASessionCard = () => {
  ...
  const totalScores = useMemo(
    ...
    [t, ktAxaSoftSkillsData, ktAxaKnowledgeSkillsData],
  );
  ...
  const handleListenToFeedback = () => {
    if (isAudioPlaying) {
      ...
      if (feedbackSections.length > 0) {
        ...
        // Pass 'kt-axa' as companyFriendlyId for correct pronunciation dictionary
        // Use streaming for all languages (including Thai) for faster playback start
        playStreamingAudio(fullFeedbackText, undefined, undefined, undefined, undefined, 'kt-axa');
      }
    }
  };
...
export default KTAXASessionCard;

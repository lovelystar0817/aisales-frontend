...
export default function PrudentialPHAppointmentSettingSections() {
  ...
  return (
    <section className="space-y-4">
      {data.sections.map(
        (section: PrudentialPHAppointmentSettingSection, index: number) => (
          <div key={index} className="rounded-2xl bg-white p-4">
            ...
            <p className="mb-3 text-[14px] text-[#58595A]">
              {section.feedback}
            </p>
